...
#define LAB3_ELFBINFILE_LEN  0x0000800c
#define LAB1_ELF_EXEC_ADDR  0x002005a4 // ELF main() entry point
#define LAB3_ELF_EXEC_ADDR  0x006005a4
#endif

#ifdef ZYBO
#define LAB1_BITFILE_LEN  0x001FCBA0 // BIN formatted BITfile length
#define LAB3_BITFILE_LEN  0x001FCBA0
#define LAB1_ELFBIN_ADDR  0x00200000 // BIN formatted ELF address
#define LAB3_ELFBIN_ADDR  0x00600000
#define LAB1_ELFBINFILE_LEN  0x00008008 // BIN formatted ELF length
#define LAB3_ELFBINFILE_LEN  0x00008008
#define LAB1_ELF_EXEC_ADDR  0x002005e4 // ELF main() entry point
#define LAB3_ELF_EXEC_ADDR  0x006005e4
#endif
