...
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_fir_top_0_0 || ORIG_REF_NAME==system_fir_top_0_0}]

# IP: bd/system/ip/system_fir_top_0_1/system_fir_top_0_1.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_fir_top_0_1 || ORIG_REF_NAME==system_fir_top_0_1}]
