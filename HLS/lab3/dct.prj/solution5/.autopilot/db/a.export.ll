...
.preheader2:                                      ; preds = %.preheader2.preheader
  ...
  %tmp_2 = add i8 %tmp_9_cast, %tmp_3_mid2_cast
  %tmp_11_cast = zext i8 %tmp_2 to i64
...
.preheader:                                       ; preds = %.preheader.preheader
  ...
  %tmp_7 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %tmp_9_mid2_v, i3 0)
  %tmp_14_cast = zext i7 %tmp_7 to i8
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @p_str9) nounwind
  %tmp_s = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @p_str9)
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind
  %tmp_2_cast = zext i4 %i_3_mid2 to i8
  %tmp_9 = add i8 %tmp_2_cast, %tmp_14_cast
  %tmp_15_cast = zext i8 %tmp_9 to i64
  ...
  %tmp_17_cast = zext i7 %tmp_10 to i8
  %tmp_11 = add i8 %tmp_9_mid2_cast, %tmp_17_cast
  %tmp_18_cast = zext i8 %tmp_11 to i64
  ...
  %empty_11 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @p_str9, i32 %tmp_s)
...
define internal fastcc void @dct_1d([8 x i16]* nocapture %src, [8 x i16]* nocapture %src1, [8 x i16]* nocapture %src2, [8 x i16]* nocapture %src3, [8 x i16]* nocapture %src4, [8 x i16]* nocapture %src5, [8 x i16]* nocapture %src6, [8 x i16]* nocapture %src7, i4 %tmp_6, [64 x i16]* nocapture %dst, i4 %tmp_61) {
  ...
  %tmp_12 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %tmp_61_read, i3 0)
  %tmp_20_cast = zext i7 %tmp_12 to i8
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str) nounwind
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind
  %tmp_s = zext i4 %k to i64
  %tmp_cast = zext i4 %k to i8
  %tmp_13 = add i8 %tmp_20_cast, %tmp_cast
  %tmp_21_cast = zext i8 %tmp_13 to i64
  %dst_addr = getelementptr [64 x i16]* %dst, i64 0, i64 %tmp_21_cast
  ...
  %tmp_171_cast = sext i16 %src_load to i29
  %tmp_4 = mul i29 %coeff_cast, %tmp_171_cast
  ...
  %tmp_18_1 = mul i29 %coeff_1_cast, %tmp_17_1_cast
  ...
  %tmp_18_2 = mul i29 %coeff_2_cast, %tmp_17_2_cast
  ...
  %tmp_18_3 = mul i29 %coeff_3_cast, %tmp_17_3_cast
  ...
  %tmp_18_4 = mul i29 %coeff_4_cast, %tmp_17_4_cast
  ...
  %tmp_18_5 = mul i29 %coeff_5_cast, %tmp_17_5_cast
  ...
  %tmp_18_6 = mul i29 %coeff_6_cast, %tmp_17_6_cast
  ...
  %tmp_18_7 = mul i29 %coeff_7_cast, %tmp_17_7_cast
  %tmp2 = add i29 %tmp_18_1, %tmp_4
  ...
  %tmp_5 = add i29 %tmp1, %tmp4
  %tmp_7 = call i16 @_ssdm_op_PartSelect.i16.i29.i32.i32(i29 %tmp_5, i32 13, i32 28)
  store i16 %tmp_7, i16* %dst_addr, align 2
  %empty_12 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str, i32 %tmp_3) nounwind
  br label %1
