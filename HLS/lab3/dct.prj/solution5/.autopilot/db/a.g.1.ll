; ModuleID = '/home/lfvelez/Documentos/ISPR/HLS/labsource/labs/lab3/dct.prj/solution5/.autopilot/db/a.g.1.bc'
...
define internal fastcc void @dct_2d([8 x i16]* %in_block, [8 x i16]* %out_block) nounwind uwtable {
  ...
  %col_inbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %col_inbuf, i64 0, i64 0, !dbg !117 ; [#uses=1 type=[8 x i16]*] [debug line = 28:1]
  call void (...)* @_ssdm_SpecArrayPartition([8 x i16]* %col_inbuf.addr, i32 2, i8* getelementptr inbounds ([9 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !117 ; [debug line = 28:1]
...
; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([13 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !122 ; [debug line = 32:66]
  %rbegin3 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([13 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !122 ; [#uses=1 type=i32] [debug line = 32:66]
  %tmp.13 = zext i32 %i to i64, !dbg !124         ; [#uses=2 type=i64] [debug line = 33:7]
  %in_block.addr = getelementptr inbounds [8 x i16]* %in_block, i64 %tmp.13, i64 0, !dbg !124 ; [#uses=1 type=i16*] [debug line = 33:7]
  %row_outbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %row_outbuf, i64 0, i64 %tmp.13, i64 0, !dbg !124 ; [#uses=1 type=i16*] [debug line = 33:7]
  call fastcc void @dct_1d(i16* %in_block.addr, i16* %row_outbuf.addr), !dbg !124 ; [debug line = 33:7]
  %rend4 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([13 x i8]* @.str4, i64 0, i64 0), i32 %rbegin3) nounwind, !dbg !125 ; [#uses=0 type=i32] [debug line = 34:4]
...
.preheader2:                                      ; preds = %6, %.preheader2.preheader
  ...
  %tmp.15 = icmp eq i32 %j, 8, !dbg !120          ; [#uses=1 type=i1] [debug line = 37:9]
  br i1 %tmp.15, label %.preheader1.preheader, label %3, !dbg !120 ; [debug line = 37:9]

.preheader1.preheader:                            ; preds = %.preheader2
  br label %.preheader1, !dbg !129                ; [debug line = 43:9]

; <label>:3                                       ; preds = %.preheader2
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([21 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !131 ; [debug line = 38:1]
  %rbegin1 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([21 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !131 ; [#uses=1 type=i32] [debug line = 38:1]
  %tmp.16 = zext i32 %j to i64, !dbg !133         ; [#uses=2 type=i64] [debug line = 40:1]
  br label %4, !dbg !136                          ; [debug line = 39:11]

; <label>:4                                       ; preds = %5, %3
  %i.1 = phi i32 [ 0, %3 ], [ %i.6, %5 ]          ; [#uses=3 type=i32]
  %tmp.18 = icmp eq i32 %i.1, 8, !dbg !136        ; [#uses=1 type=i1] [debug line = 39:11]
  br i1 %tmp.18, label %6, label %5, !dbg !136    ; [debug line = 39:11]

; <label>:5                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([21 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !137 ; [debug line = 40:2]
  %rbegin9 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([21 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !137 ; [#uses=1 type=i32] [debug line = 40:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !138 ; [debug line = 41:1]
  %tmp.22 = zext i32 %i.1 to i64, !dbg !133       ; [#uses=2 type=i64] [debug line = 40:1]
  %row_outbuf.addr.1 = getelementptr inbounds [8 x [8 x i16]]* %row_outbuf, i64 0, i64 %tmp.22, i64 %tmp.16, !dbg !133 ; [#uses=1 type=i16*] [debug line = 40:1]
  %row_outbuf.load = load i16* %row_outbuf.addr.1, align 2, !dbg !133 ; [#uses=2 type=i16] [debug line = 40:1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %row_outbuf.load) nounwind
  %col_inbuf.addr.2 = getelementptr inbounds [8 x [8 x i16]]* %col_inbuf, i64 0, i64 %tmp.16, i64 %tmp.22, !dbg !133 ; [#uses=1 type=i16*] [debug line = 40:1]
  store i16 %row_outbuf.load, i16* %col_inbuf.addr.2, align 2, !dbg !133 ; [debug line = 40:1]
  %rend10 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([21 x i8]* @.str6, i64 0, i64 0), i32 %rbegin9) nounwind, !dbg !139 ; [#uses=0 type=i32] [debug line = 40:34]
...
; <label>:6                                       ; preds = %4
  %rend12 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([21 x i8]* @.str5, i64 0, i64 0), i32 %rbegin1) nounwind, !dbg !141 ; [#uses=0 type=i32] [debug line = 40:34]
...
.preheader1:                                      ; preds = %7, %.preheader1.preheader
  ...
  %tmp.17 = icmp eq i32 %i.2, 8, !dbg !129        ; [#uses=1 type=i1] [debug line = 43:9]
  br i1 %tmp.17, label %.preheader.preheader, label %7, !dbg !129 ; [debug line = 43:9]

.preheader.preheader:                             ; preds = %.preheader1
  br label %.preheader, !dbg !144                 ; [debug line = 48:9]

; <label>:7                                       ; preds = %.preheader1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([13 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !146 ; [debug line = 43:67]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([13 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !146 ; [#uses=1 type=i32] [debug line = 43:67]
  %tmp.19 = zext i32 %i.2 to i64, !dbg !148       ; [#uses=2 type=i64] [debug line = 44:7]
  %col_inbuf.addr.1 = getelementptr inbounds [8 x [8 x i16]]* %col_inbuf, i64 0, i64 %tmp.19, i64 0, !dbg !148 ; [#uses=1 type=i16*] [debug line = 44:7]
  %col_outbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %col_outbuf, i64 0, i64 %tmp.19, i64 0, !dbg !148 ; [#uses=1 type=i16*] [debug line = 44:7]
  call fastcc void @dct_1d(i16* %col_inbuf.addr.1, i16* %col_outbuf.addr), !dbg !148 ; [debug line = 44:7]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([13 x i8]* @.str7, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !149 ; [#uses=0 type=i32] [debug line = 45:4]
...
.preheader:                                       ; preds = %11, %.preheader.preheader
  ...
  %tmp.24 = icmp eq i32 %j.1, 8, !dbg !144        ; [#uses=1 type=i1] [debug line = 48:9]
  br i1 %tmp.24, label %12, label %8, !dbg !144   ; [debug line = 48:9]

; <label>:8                                       ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([21 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !151 ; [debug line = 49:1]
  %rbegin7 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([21 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !151 ; [#uses=1 type=i32] [debug line = 49:1]
  %tmp.25 = zext i32 %j.1 to i64, !dbg !153       ; [#uses=2 type=i64] [debug line = 51:1]
  br label %9, !dbg !156                          ; [debug line = 50:11]

; <label>:9                                       ; preds = %10, %8
  %i.3 = phi i32 [ 0, %8 ], [ %i.7, %10 ]         ; [#uses=3 type=i32]
  %tmp.26 = icmp eq i32 %i.3, 8, !dbg !156        ; [#uses=1 type=i1] [debug line = 50:11]
  br i1 %tmp.26, label %11, label %10, !dbg !156  ; [debug line = 50:11]

; <label>:10                                      ; preds = %9
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([21 x i8]* @.str9, i64 0, i64 0)) nounwind, !dbg !157 ; [debug line = 51:2]
  %rbegin5 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([21 x i8]* @.str9, i64 0, i64 0)) nounwind, !dbg !157 ; [#uses=1 type=i32] [debug line = 51:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !158 ; [debug line = 52:1]
  %tmp.28 = zext i32 %i.3 to i64, !dbg !153       ; [#uses=2 type=i64] [debug line = 51:1]
  %col_outbuf.addr.1 = getelementptr inbounds [8 x [8 x i16]]* %col_outbuf, i64 0, i64 %tmp.28, i64 %tmp.25, !dbg !153 ; [#uses=1 type=i16*] [debug line = 51:1]
  %col_outbuf.load = load i16* %col_outbuf.addr.1, align 2, !dbg !153 ; [#uses=2 type=i16] [debug line = 51:1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %col_outbuf.load) nounwind
  %out_block.addr = getelementptr inbounds [8 x i16]* %out_block, i64 %tmp.25, i64 %tmp.28, !dbg !153 ; [#uses=1 type=i16*] [debug line = 51:1]
  store i16 %col_outbuf.load, i16* %out_block.addr, align 2, !dbg !153 ; [debug line = 51:1]
  %rend6 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([21 x i8]* @.str9, i64 0, i64 0), i32 %rbegin5) nounwind, !dbg !159 ; [#uses=0 type=i32] [debug line = 51:34]
...
; <label>:11                                      ; preds = %9
  %rend8 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([21 x i8]* @.str8, i64 0, i64 0), i32 %rbegin7) nounwind, !dbg !161 ; [#uses=0 type=i32] [debug line = 51:34]
...
define internal fastcc void @dct_1d(i16* %src, i16* %dst) nounwind uwtable {
  ...
  call void (...)* @_ssdm_SpecArrayDimSize(i16* %dst, i32 8) nounwind, !dbg !168 ; [debug line = 5:2]
  call void (...)* @_ssdm_SpecArrayDimSize(i16* %src, i32 8) nounwind, !dbg !170 ; [debug line = 5:32]
...
; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([15 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !173 ; [debug line = 13:67]
  %rbegin1 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !173 ; [#uses=1 type=i32] [debug line = 13:67]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !175 ; [debug line = 14:1]
  %tmp.30 = zext i32 %k to i64, !dbg !176         ; [#uses=2 type=i64] [debug line = 16:48]
  br label %3, !dbg !179                          ; [debug line = 15:11]

; <label>:3                                       ; preds = %4, %2
  %n = phi i32 [ 0, %2 ], [ %n.1, %4 ]            ; [#uses=3 type=i32]
  %tmp31 = phi i32 [ 0, %2 ], [ %tmp.40, %4 ]     ; [#uses=2 type=i32]
  %tmp.32 = icmp eq i32 %n, 8, !dbg !179          ; [#uses=1 type=i1] [debug line = 15:11]
  br i1 %tmp.32, label %5, label %4, !dbg !179    ; [debug line = 15:11]

; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([15 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !180 ; [debug line = 15:78]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !180 ; [#uses=1 type=i32] [debug line = 15:78]
  %tmp.37 = zext i32 %n to i64, !dbg !176         ; [#uses=2 type=i64] [debug line = 16:48]
  %dct_coeff_table.addr = getelementptr inbounds [8 x [8 x i16]]* @dct_coeff_table, i64 0, i64 %tmp.30, i64 %tmp.37, !dbg !176 ; [#uses=1 type=i16*] [debug line = 16:48]
  %dct_coeff_table.load = load i16* %dct_coeff_table.addr, align 2, !dbg !176 ; [#uses=2 type=i16] [debug line = 16:48]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %dct_coeff_table.load) nounwind
  %coeff = sext i16 %dct_coeff_table.load to i32, !dbg !176 ; [#uses=1 type=i32] [debug line = 16:48]
  call void @llvm.dbg.value(metadata !{i32 %coeff}, i64 0, metadata !181), !dbg !176 ; [debug line = 16:48] [debug variable = coeff]
  %src.addr = getelementptr inbounds i16* %src, i64 %tmp.37, !dbg !182 ; [#uses=1 type=i16*] [debug line = 17:10]
  ...
  %tmp.38 = sext i16 %src.load to i32, !dbg !182  ; [#uses=1 type=i32] [debug line = 17:10]
  %tmp.39 = mul nsw i32 %tmp.38, %coeff, !dbg !182 ; [#uses=1 type=i32] [debug line = 17:10]
  %tmp.40 = add nsw i32 %tmp.39, %tmp31, !dbg !182 ; [#uses=1 type=i32] [debug line = 17:10]
  call void @llvm.dbg.value(metadata !{i32 %tmp.40}, i64 0, metadata !183), !dbg !182 ; [debug line = 17:10] [debug variable = tmp]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str2, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !184 ; [#uses=0 type=i32] [debug line = 18:7]
...
; <label>:5                                       ; preds = %3
  ...
  %tmp.33 = add nsw i32 %tmp.0.lcssa, 4096, !dbg !187 ; [#uses=1 type=i32] [debug line = 19:7]
  %tmp.34 = lshr i32 %tmp.33, 13, !dbg !187       ; [#uses=1 type=i32] [debug line = 19:7]
  %tmp.35 = trunc i32 %tmp.34 to i16, !dbg !187   ; [#uses=1 type=i16] [debug line = 19:7]
  %dst.addr = getelementptr inbounds i16* %dst, i64 %tmp.30, !dbg !187 ; [#uses=1 type=i16*] [debug line = 19:7]
  store i16 %tmp.35, i16* %dst.addr, align 2, !dbg !187 ; [debug line = 19:7]
  %rend2 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str, i64 0, i64 0), i32 %rbegin1) nounwind, !dbg !188 ; [#uses=0 type=i32] [debug line = 20:4]
...
define void @dct(i16* %input, i16* %output) nounwind uwtable {
  ...
  call void (...)* @_ssdm_SpecArrayDimSize(i16* %output, i32 64) nounwind, !dbg !196 ; [debug line = 79:2]
  call void (...)* @_ssdm_SpecArrayDimSize(i16* %input, i32 64) nounwind, !dbg !198 ; [debug line = 79:41]
  call void (...)* @_ssdm_op_SpecDataflowPipeline(i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !199 ; [debug line = 80:1]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %buf_2d_in}, metadata !200), !dbg !202 ; [debug line = 81:10] [debug variable = buf_2d_in]
  %buf_2d_in.addr = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_in, i64 0, i64 0, !dbg !203 ; [#uses=3 type=[8 x i16]*] [debug line = 82:1]
  call void (...)* @_ssdm_SpecArrayPartition([8 x i16]* %buf_2d_in.addr, i32 2, i8* getelementptr inbounds ([9 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !203 ; [debug line = 82:1]
  ...
  %buf_2d_out.addr = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_out, i64 0, i64 0, !dbg !207 ; [#uses=2 type=[8 x i16]*] [debug line = 87:4]
...
!134 = metadata !{i32 786443, metadata !135, i32 40, i32 1, metadata !6, i32 11} ; [ DW_TAG_lexical_block ]
!135 = metadata !{i32 786443, metadata !132, i32 39, i32 7, metadata !6, i32 10} ; [ DW_TAG_lexical_block ]
!136 = metadata !{i32 39, i32 11, metadata !135, null}
!137 = metadata !{i32 40, i32 2, metadata !134, null}
!138 = metadata !{i32 41, i32 1, metadata !134, null}
!139 = metadata !{i32 40, i32 34, metadata !134, null}
!140 = metadata !{i32 39, i32 63, metadata !135, null}
!141 = metadata !{i32 40, i32 34, metadata !135, null}
...
!154 = metadata !{i32 786443, metadata !155, i32 51, i32 1, metadata !6, i32 17} ; [ DW_TAG_lexical_block ]
!155 = metadata !{i32 786443, metadata !152, i32 50, i32 7, metadata !6, i32 16} ; [ DW_TAG_lexical_block ]
...
!176 = metadata !{i32 16, i32 48, metadata !177, null}
!177 = metadata !{i32 786443, metadata !178, i32 15, i32 77, metadata !6, i32 4} ; [ DW_TAG_lexical_block ]
!178 = metadata !{i32 786443, metadata !174, i32 15, i32 7, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
!179 = metadata !{i32 15, i32 11, metadata !178, null}
!180 = metadata !{i32 15, i32 78, metadata !177, null}
!181 = metadata !{i32 786688, metadata !177, metadata !"coeff", metadata !6, i32 16, metadata !78, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!182 = metadata !{i32 17, i32 10, metadata !177, null}
!183 = metadata !{i32 786688, metadata !169, metadata !"tmp", metadata !6, i32 7, metadata !78, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!184 = metadata !{i32 18, i32 7, metadata !177, null}
!185 = metadata !{i32 15, i32 72, metadata !178, null}
