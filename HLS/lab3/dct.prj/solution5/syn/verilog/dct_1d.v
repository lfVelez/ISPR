...
wire   [7:0] tmp_13_fu_348_p2;
reg   [7:0] tmp_13_reg_548;
reg   [7:0] ap_reg_pp0_iter1_tmp_13_reg_548;
reg   [7:0] ap_reg_pp0_iter2_tmp_13_reg_548;
reg   [7:0] ap_reg_pp0_iter3_tmp_13_reg_548;
reg   [7:0] ap_reg_pp0_iter4_tmp_13_reg_548;
...
wire   [63:0] tmp_21_cast_fu_424_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        ...
        tmp_20_cast_reg_485[6 : 3] <= tmp_20_cast_fu_309_p1[6 : 3];
    end
end
...
always @ (posedge ap_clk) begin
    if (((ap_block_pp0_stage0_flag00011001 == 1'b0) & (ap_reg_pp0_iter3_tmp_reg_530 == 1'd0))) begin
        tmp_7_reg_703 <= {{tmp_5_fu_409_p2[28:13]}};
    end
end
...
assign dst_address0 = tmp_21_cast_fu_424_p1;

assign dst_d0 = tmp_7_reg_703;

assign grp_fu_446_p0 = grp_fu_446_p00;

assign grp_fu_446_p00 = dct_coeff_table_0_lo_reg_623;
...
assign tmp_12_fu_301_p3 = {{tmp_61}, {3'd0}};

assign tmp_13_fu_348_p2 = (tmp_20_cast_reg_485 + tmp_cast_fu_344_p1);

assign tmp_20_cast_fu_309_p1 = tmp_12_fu_301_p3;

assign tmp_21_cast_fu_424_p1 = ap_reg_pp0_iter4_tmp_13_reg_548;

assign tmp_5_fu_409_p2 = (tmp1_reg_688 + tmp4_fu_405_p2);
...
always @ (posedge ap_clk) begin
    tmp_20_cast_reg_485[2:0] <= 3'b000;
    tmp_20_cast_reg_485[7] <= 1'b0;
