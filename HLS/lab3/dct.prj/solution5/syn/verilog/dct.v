...
(* CORE_GENERATION_INFO="dct,hls_ip_2017_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=9.727437,HLS_SYN_LAT=528,HLS_SYN_TPT=393,HLS_SYN_MEM=4,HLS_SYN_DSP=8,HLS_SYN_FF=1699,HLS_SYN_LUT=1702}" *)
