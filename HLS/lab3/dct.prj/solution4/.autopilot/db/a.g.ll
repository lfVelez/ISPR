; ModuleID = '/home/lfvelez/Documentos/ISPR/HLS/labsource/labs/lab3/dct.prj/solution4/.autopilot/db/a.g.bc'
...
define void @dct(i16* %input, i16* %output) nounwind uwtable {
  ...
  call void (...)* @_ssdm_SpecArrayPartition([8 x i16]* %5, i32 2, i8* getelementptr inbounds ([9 x i8]* @.str3, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !223 ; [debug line = 82:1]
  ...
  %6 = load i16** %1, align 8, !dbg !226          ; [#uses=1 type=i16*] [debug line = 85:4]
  ...
  %11 = load i16** %2, align 8, !dbg !228         ; [#uses=1 type=i16*] [debug line = 90:4]
