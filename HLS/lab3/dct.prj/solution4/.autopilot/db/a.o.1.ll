; ModuleID = '/home/lfvelez/Documentos/ISPR/HLS/labsource/labs/lab3/dct.prj/solution4/.autopilot/db/a.g.1.bc'
...
define void @dct(i16* %input, i16* %output) nounwind uwtable {
  ...
  %buf_2d_in.addr = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_in, i64 0, i64 0, !dbg !202 ; [#uses=3 type=[8 x i16]*] [debug line = 82:1]
  call void (...)* @_ssdm_SpecArrayPartition([8 x i16]* %buf_2d_in.addr, i32 2, i8* getelementptr inbounds ([9 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !202 ; [debug line = 82:1]
  ...
  %buf_2d_out.addr = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_out, i64 0, i64 0, !dbg !206 ; [#uses=2 type=[8 x i16]*] [debug line = 87:4]
