...
architecture behav of read_data is 
    ...
    signal c_cast2_fu_276_p1 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, exitcond_flatten_fu_221_p2, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_flag00011011, ap_enable_reg_pp0_iter2)
    begin
        case ap_CS_fsm is
    ...
    c_1_fu_290_p2 <= std_logic_vector(unsigned(c_mid2_reg_315) + unsigned(ap_const_lv4_1));
    c_cast2_fu_276_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(c_mid2_reg_315),6));
    c_mid2_fu_245_p3 <= 
        ap_const_lv4_0 when (exitcond_fu_239_p2(0) = '1') else 
        c_phi_fu_214_p4;

    c_phi_fu_214_p4_assign_proc : process(c_reg_210, exitcond_flatten_reg_306, ap_CS_fsm_pp0_stage0, c_1_fu_290_p2, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_flag00000000)
    begin
    ...
    tmp_9_fu_279_p2 <= std_logic_vector(unsigned(c_cast2_fu_276_p1) + unsigned(tmp_mid2_fu_269_p3));
