...
(* CORE_GENERATION_INFO="dct,hls_ip_2017_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=9.727437,HLS_SYN_LAT=529,HLS_SYN_TPT=none,HLS_SYN_MEM=3,HLS_SYN_DSP=8,HLS_SYN_FF=1437,HLS_SYN_LUT=1911}" *)
...
reg   [0:0] exitcond_flatten_reg_314;
wire    ap_CS_fsm_pp0_stage0;
wire    ap_block_state5_pp0_stage0_iter0;
wire    ap_block_state6_pp0_stage0_iter1;
wire    ap_block_state7_pp0_stage0_iter2;
wire    ap_block_pp0_stage0_flag00011001;
reg   [0:0] ap_reg_pp0_iter1_exitcond_flatten_reg_314;
wire   [6:0] indvar_flatten_next_fu_226_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [3:0] c_i_mid2_fu_244_p3;
reg   [3:0] c_i_mid2_reg_323;
wire   [3:0] tmp_i_mid2_v_fu_252_p3;
reg   [3:0] tmp_i_mid2_v_reg_330;
wire   [2:0] tmp_4_fu_260_p1;
reg   [2:0] tmp_4_reg_336;
wire   [5:0] tmp_4_i_fu_299_p2;
reg   [5:0] tmp_4_i_reg_346;
...
reg   [3:0] c_i_phi_fu_162_p4;
reg    ap_reg_grp_dct_2d_fu_169_ap_start;
wire    ap_CS_fsm_state3;
reg    ap_reg_grp_read_data_fu_198_ap_start;
wire    ap_CS_fsm_state2;
wire   [63:0] tmp_21_cast_fu_294_p1;
wire   [63:0] tmp_5_i_fu_310_p1;
wire   [0:0] exitcond_i3_fu_238_p2;
wire   [3:0] r_fu_232_p2;
wire   [6:0] tmp_fu_264_p3;
wire   [7:0] tmp_19_cast_fu_271_p1;
wire   [7:0] tmp_3_i_cast_fu_285_p1;
wire   [7:0] tmp_s_fu_288_p2;
wire   [5:0] c_i_cast2_fu_282_p1;
wire   [5:0] tmp_1_i_mid2_fu_275_p3;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (1'b1 == ap_condition_pp0_exit_iter0_state5))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state4) & (grp_dct_2d_fu_169_ap_done == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((1'b1 == grp_dct_2d_fu_169_ap_ready)) begin
            ap_reg_grp_dct_2d_fu_169_ap_start <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((1'b1 == grp_read_data_fu_198_ap_ready)) begin
            ap_reg_grp_read_data_fu_198_ap_start <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (exitcond_flatten_reg_314 == 1'd0) & (1'b1 == ap_enable_reg_pp0_iter1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter0) & (exitcond_flatten_fu_220_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (exitcond_flatten_fu_220_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (exitcond_flatten_reg_314 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (ap_block_pp0_stage0_flag00000000 == 1'b0))) begin
        buf_2d_out_address0 = tmp_21_cast_fu_294_p1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond_flatten_reg_314 == 1'd0) & (1'b1 == ap_enable_reg_pp0_iter1) & (ap_block_pp0_stage0_flag00000000 == 1'b0))) begin
...
always @ (*) begin
    if (((ap_block_pp0_stage0_flag00011001 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter2) & (ap_reg_pp0_iter1_exitcond_flatten_reg_314 == 1'd0))) begin
        output_r_we0 = 1'b1;
    end else begin
        output_r_we0 = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b1 == ap_CS_fsm_state2) & (grp_read_data_fu_198_ap_done == 1'b1))) begin
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b1 == ap_CS_fsm_state4) & (grp_dct_2d_fu_169_ap_done == 1'b1))) begin
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_block_pp0_stage0_flag00011011 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter2) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((1'b1 == ap_enable_reg_pp0_iter0) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (exitcond_flatten_fu_220_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_block_pp0_stage0_flag00011011 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter2) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((1'b1 == ap_enable_reg_pp0_iter0) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (exitcond_flatten_fu_220_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
...
assign c_fu_305_p2 = (4'd1 + c_i_mid2_reg_323);

assign c_i_cast2_fu_282_p1 = c_i_mid2_reg_323;

assign c_i_mid2_fu_244_p3 = ((exitcond_i3_fu_238_p2[0:0] === 1'b1) ? 4'd0 : c_i_phi_fu_162_p4);

assign exitcond_flatten_fu_220_p2 = ((indvar_flatten_reg_136 == 7'd64) ? 1'b1 : 1'b0);

assign exitcond_i3_fu_238_p2 = ((c_i_phi_fu_162_p4 == 4'd8) ? 1'b1 : 1'b0);
...
assign output_r_address0 = tmp_5_i_fu_310_p1;

assign output_r_d0 = buf_2d_out_q0;

assign r_fu_232_p2 = (4'd1 + r_i_phi_fu_151_p4);

assign tmp_19_cast_fu_271_p1 = tmp_fu_264_p3;

assign tmp_1_i_mid2_fu_275_p3 = {{tmp_4_reg_336}, {3'd0}};

assign tmp_21_cast_fu_294_p1 = tmp_s_fu_288_p2;

assign tmp_3_i_cast_fu_285_p1 = c_i_mid2_reg_323;

assign tmp_4_fu_260_p1 = tmp_i_mid2_v_fu_252_p3[2:0];

assign tmp_4_i_fu_299_p2 = (c_i_cast2_fu_282_p1 + tmp_1_i_mid2_fu_275_p3);

assign tmp_5_i_fu_310_p1 = tmp_4_i_reg_346;

assign tmp_fu_264_p3 = {{tmp_i_mid2_v_reg_330}, {3'd0}};

assign tmp_i_mid2_v_fu_252_p3 = ((exitcond_i3_fu_238_p2[0:0] === 1'b1) ? r_fu_232_p2 : r_i_phi_fu_151_p4);

assign tmp_s_fu_288_p2 = (tmp_19_cast_fu_271_p1 + tmp_3_i_cast_fu_285_p1);
