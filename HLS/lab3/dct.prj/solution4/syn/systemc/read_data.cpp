...
read_data::read_data(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_c_cast2_fu_276_p1);
    sensitive << ( c_mid2_reg_315 );
    ...
    sc_trace(mVcdFile, c_cast2_fu_276_p1, "c_cast2_fu_276_p1");
...
void read_data::thread_c_1_fu_290_p2() {
    c_1_fu_290_p2 = (!c_mid2_reg_315.read().is_01() || !ap_const_lv4_1.is_01())? sc_lv<4>(): (sc_biguint<4>(c_mid2_reg_315.read()) + sc_biguint<4>(ap_const_lv4_1));
}

void read_data::thread_c_cast2_fu_276_p1() {
    c_cast2_fu_276_p1 = esl_zext<6,4>(c_mid2_reg_315.read());
}
...
void read_data::thread_c_phi_fu_214_p4() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
        ...
        c_phi_fu_214_p4 = c_1_fu_290_p2.read();
    } else {
...
void read_data::thread_r_1_fu_233_p2() {
...
void read_data::thread_tmp_9_fu_279_p2() {
    tmp_9_fu_279_p2 = (!c_cast2_fu_276_p1.read().is_01() || !tmp_mid2_fu_269_p3.read().is_01())? sc_lv<6>(): (sc_biguint<6>(c_cast2_fu_276_p1.read()) + sc_biguint<6>(tmp_mid2_fu_269_p3.read()));
}
