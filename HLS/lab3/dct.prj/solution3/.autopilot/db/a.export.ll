...
define internal fastcc void @dct_1d2([64 x i16]* nocapture %src, i4 %tmp_6, [64 x i16]* nocapture %dst, i4 %tmp_61) {
  ...
  %tmp_21_cast = zext i7 %tmp_15 to i8
  %tmp_16 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %tmp_6_read, i3 0)
  %tmp_17 = zext i7 %tmp_16 to i64
  %src_addr = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_17
  %tmp_18 = or i7 %tmp_16, 1
  %tmp_19 = call i64 @_ssdm_op_BitConcatenate.i64.i57.i7(i57 0, i7 %tmp_18)
  %src_addr_1 = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_19
  %tmp_20 = or i7 %tmp_16, 2
  %tmp_21 = call i64 @_ssdm_op_BitConcatenate.i64.i57.i7(i57 0, i7 %tmp_20)
  %src_addr_2 = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_21
  %tmp_22 = or i7 %tmp_16, 3
  %tmp_23 = call i64 @_ssdm_op_BitConcatenate.i64.i57.i7(i57 0, i7 %tmp_22)
  %src_addr_3 = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_23
  %tmp_24 = or i7 %tmp_16, 4
  %tmp_25 = call i64 @_ssdm_op_BitConcatenate.i64.i57.i7(i57 0, i7 %tmp_24)
  %src_addr_4 = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_25
  %tmp_26 = or i7 %tmp_16, 5
  %tmp_27 = call i64 @_ssdm_op_BitConcatenate.i64.i57.i7(i57 0, i7 %tmp_26)
  %src_addr_5 = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_27
  %tmp_28 = or i7 %tmp_16, 6
  %tmp_29 = call i64 @_ssdm_op_BitConcatenate.i64.i57.i7(i57 0, i7 %tmp_28)
  %src_addr_6 = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_29
  %tmp_30 = or i7 %tmp_16, 7
  %tmp_31 = call i64 @_ssdm_op_BitConcatenate.i64.i57.i7(i57 0, i7 %tmp_30)
  %src_addr_7 = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_31
  br label %1
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_32 = add i8 %tmp_21_cast, %tmp_cast
  %tmp_38_cast = zext i8 %tmp_32 to i64
  %dst_addr = getelementptr [64 x i16]* %dst, i64 0, i64 %tmp_38_cast
  ...
  %tmp_16_cast = sext i16 %src_load to i29
  %tmp_14 = mul i29 %tmp_16_cast, %coeff_cast
  ...
  %tmp_17_1_cast = sext i16 %src_load_1 to i29
  ...
  %tmp_17_2_cast = sext i16 %src_load_2 to i29
  ...
  %tmp_17_3_cast = sext i16 %src_load_3 to i29
  ...
  %tmp_17_4_cast = sext i16 %src_load_4 to i29
  ...
  %tmp_17_5_cast = sext i16 %src_load_5 to i29
  ...
  %tmp_17_6_cast = sext i16 %src_load_6 to i29
  ...
  %tmp_17_7_cast = sext i16 %src_load_7 to i29
  ...
  %empty_10 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str, i32 %tmp_12) nounwind
  br label %1
...
.reset:                                           ; preds = %1
  ...
  %tmp_40_cast = zext i7 %tmp_s to i8
  ...
  %tmp_33 = add i8 %tmp_40_cast, %tmp_1_i_cast
  %tmp_41_cast = zext i8 %tmp_33 to i64
  %buf_2d_in_addr = getelementptr [64 x i16]* %buf_2d_in, i64 0, i64 %tmp_41_cast
...
.reset10:                                         ; preds = %2
  ...
  %tmp_34 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %tmp_i4_mid2_v, i3 0)
  %tmp_43_cast = zext i7 %tmp_34 to i8
  ...
  %tmp_35 = add i8 %tmp_43_cast, %tmp_3_i_cast
  %tmp_45_cast = zext i8 %tmp_35 to i64
  %buf_2d_out_addr = getelementptr [64 x i16]* %buf_2d_out, i64 0, i64 %tmp_45_cast
