; ModuleID = '/home/lfvelez/Documentos/ISPR/HLS/labsource/labs/lab3/dct.prj/solution3/.autopilot/db/a.g.1.bc'
...
; <label>:5                                       ; preds = %4
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !137 ; [debug line = 41:1]
...
; <label>:10                                      ; preds = %9
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !157 ; [debug line = 52:1]
...
; <label>:2                                       ; preds = %1
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !174 ; [debug line = 14:1]
  %tmp.30 = zext i32 %k to i64, !dbg !175         ; [#uses=2 type=i64] [debug line = 16:48]
  br label %3, !dbg !178                          ; [debug line = 15:11]

; <label>:3                                       ; preds = %4, %2
  %n = phi i32 [ 0, %2 ], [ %n.1, %4 ]            ; [#uses=3 type=i32]
  %tmp31 = phi i32 [ 0, %2 ], [ %tmp.40, %4 ]     ; [#uses=2 type=i32]
  %tmp.32 = icmp eq i32 %n, 8, !dbg !178          ; [#uses=1 type=i1] [debug line = 15:11]
  br i1 %tmp.32, label %5, label %4, !dbg !178    ; [debug line = 15:11]

; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([15 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !179 ; [debug line = 15:78]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !179 ; [#uses=1 type=i32] [debug line = 15:78]
  %tmp.37 = zext i32 %n to i64, !dbg !175         ; [#uses=2 type=i64] [debug line = 16:48]
  %dct_coeff_table.addr = getelementptr inbounds [8 x [8 x i16]]* @dct_coeff_table, i64 0, i64 %tmp.30, i64 %tmp.37, !dbg !175 ; [#uses=1 type=i16*] [debug line = 16:48]
  %dct_coeff_table.load = load i16* %dct_coeff_table.addr, align 2, !dbg !175 ; [#uses=2 type=i16] [debug line = 16:48]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %dct_coeff_table.load) nounwind
  %coeff = sext i16 %dct_coeff_table.load to i32, !dbg !175 ; [#uses=1 type=i32] [debug line = 16:48]
  call void @llvm.dbg.value(metadata !{i32 %coeff}, i64 0, metadata !180), !dbg !175 ; [debug line = 16:48] [debug variable = coeff]
  ...
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str2, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !183 ; [#uses=0 type=i32] [debug line = 18:7]
...
!176 = metadata !{i32 786443, metadata !177, i32 15, i32 77, metadata !6, i32 4} ; [ DW_TAG_lexical_block ]
!177 = metadata !{i32 786443, metadata !173, i32 15, i32 7, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
!178 = metadata !{i32 15, i32 11, metadata !177, null}
!179 = metadata !{i32 15, i32 78, metadata !176, null}
!180 = metadata !{i32 786688, metadata !176, metadata !"coeff", metadata !6, i32 16, metadata !78, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!181 = metadata !{i32 17, i32 10, metadata !176, null}
!182 = metadata !{i32 786688, metadata !168, metadata !"tmp", metadata !6, i32 7, metadata !78, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!183 = metadata !{i32 18, i32 7, metadata !176, null}
!184 = metadata !{i32 15, i32 72, metadata !177, null}
