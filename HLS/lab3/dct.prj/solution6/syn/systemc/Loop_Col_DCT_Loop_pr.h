...
struct Loop_Col_DCT_Loop_pr : public sc_module {
    ...
    dct_mul_mul_15s_1jbC<1,1,15,16,29>* dct_mul_mul_15s_1jbC_x_U46;
    dct_mac_muladd_14kbM<1,1,14,16,29,29>* dct_mac_muladd_14kbM_x_U47;
    ...
    dct_mac_muladd_15lbW<1,1,15,16,29,29>* dct_mac_muladd_15lbW_x_U50;
    dct_mac_muladd_15mb6<1,1,15,16,14,29>* dct_mac_muladd_15mb6_x_U51;
    ...
    sc_signal< sc_lv<8> > tmp_19_cast_reg_501;
    sc_signal< sc_lv<3> > col_inbuf_0_addr_reg_506;
    sc_signal< sc_lv<3> > col_inbuf_1_addr_reg_511;
    sc_signal< sc_lv<3> > col_inbuf_2_addr_reg_516;
    sc_signal< sc_lv<3> > col_inbuf_3_addr_reg_521;
    sc_signal< sc_lv<3> > col_inbuf_4_addr_reg_526;
    sc_signal< sc_lv<3> > col_inbuf_5_addr_reg_531;
    sc_signal< sc_lv<3> > col_inbuf_6_addr_reg_536;
    sc_signal< sc_lv<3> > col_inbuf_7_addr_reg_541;
    ...
    sc_signal< sc_lv<64> > tmp_i_20_fu_344_p1;
    sc_signal< sc_lv<64> > tmp_i_20_reg_555;
    sc_signal< sc_lv<8> > tmp_6_fu_355_p2;
    sc_signal< sc_lv<8> > tmp_6_reg_564;
    sc_signal< sc_lv<8> > ap_reg_pp0_iter1_tmp_6_reg_564;
    sc_signal< sc_lv<8> > ap_reg_pp0_iter2_tmp_6_reg_564;
    sc_signal< sc_lv<8> > ap_reg_pp0_iter3_tmp_6_reg_564;
    sc_signal< sc_lv<8> > ap_reg_pp0_iter4_tmp_6_reg_564;
    sc_signal< sc_lv<15> > dct_coeff_table_1_lo_reg_589;
    sc_signal< sc_lv<16> > col_inbuf_1_load_reg_594;
    sc_signal< sc_lv<15> > dct_coeff_table_3_lo_reg_604;
    sc_signal< sc_lv<16> > col_inbuf_3_load_reg_609;
    sc_signal< sc_lv<15> > dct_coeff_table_5_lo_reg_619;
    sc_signal< sc_lv<16> > col_inbuf_5_load_reg_624;
    sc_signal< sc_lv<14> > dct_coeff_table_0_lo_reg_639;
    sc_signal< sc_lv<16> > col_inbuf_0_load_reg_644;
    ...
    sc_signal< sc_lv<16> > col_inbuf_2_load_reg_659;
    ...
    sc_signal< sc_lv<16> > col_inbuf_4_load_reg_674;
    ...
    sc_signal< sc_lv<16> > col_inbuf_6_load_reg_689;
    sc_signal< sc_lv<15> > dct_coeff_table_7_lo_reg_694;
    sc_signal< sc_lv<16> > col_inbuf_7_load_reg_699;
    sc_signal< sc_lv<29> > tmp_fu_408_p2;
    sc_signal< sc_lv<29> > tmp_reg_704;
    sc_signal< sc_lv<29> > grp_fu_469_p3;
    sc_signal< sc_lv<29> > tmp4_reg_709;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter3;
    sc_signal< sc_lv<29> > grp_fu_476_p3;
    sc_signal< sc_lv<29> > tmp5_reg_714;
    ...
    sc_signal< sc_lv<64> > tmp_20_cast_fu_431_p1;
    ...
    sc_signal< sc_lv<29> > tmp3_fu_412_p2;
    ...
    void thread_tmp_20_cast_fu_431_p1();
    void thread_tmp_2_fu_296_p2();
    void thread_tmp_3_i_fu_416_p2();
    void thread_tmp_6_fu_355_p2();
    void thread_tmp_fu_408_p2();
    void thread_tmp_i_20_fu_344_p1();
