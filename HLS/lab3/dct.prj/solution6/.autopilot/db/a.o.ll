; ModuleID = '/home/lfvelez/Documentos/ISPR/HLS/labsource/labs/lab3/dct.prj/solution6/.autopilot/db/a.o.bc'
...
define void @dct_2d([8 x i16]* %in_block, [8 x i16]* %out_block) nounwind uwtable {
  ...
  call void (...)* @_ssdm_SpecArrayPartition([8 x i16]* %5, i32 2, i8* getelementptr inbounds ([9 x i8]* @.str3, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !108 ; [debug line = 28:1]
...
define void @dct(i16* %input, i16* %output) nounwind uwtable {
  ...
  call void (...)* @_ssdm_SpecArrayPartition([8 x i16]* %5, i32 2, i8* getelementptr inbounds ([9 x i8]* @.str3, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !225 ; [debug line = 82:1]
