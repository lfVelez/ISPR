...
.reset:                                           ; preds = %1
  ...
  %tmp_mid2_v_v = select i1 %exitcond, i4 %r_2, i4 %r
...
.preheader2.i:                                    ; preds = %0
  ...
  %tmp_8_cast = zext i7 %tmp to i8
  %tmp_9 = add i8 %tmp_8_cast, %tmp_3_mid2_cast
  %tmp_9_cast = zext i8 %tmp_9 to i64
  %row_outbuf_i_addr = getelementptr [64 x i16]* %row_outbuf_i, i64 0, i64 %tmp_9_cast
...
; <label>:0                                       ; preds = %ifBlock, %newFuncRoot
  ...
  %j_0_i = phi i4 [ 0, %newFuncRoot ], [ %tmp_3_mid2_v, %ifBlock ]
...
.preheader.i:                                     ; preds = %0
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind
  %tmp_5_cast = zext i4 %i_3_i_mid2 to i8
  %tmp_1 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_3_i_mid2, i3 0)
  %tmp_12_cast = zext i7 %tmp_1 to i8
  %tmp_2 = add i8 %tmp_7_mid2_cast, %tmp_12_cast
  %tmp_13_cast = zext i8 %tmp_2 to i64
  %col_outbuf_i_addr = getelementptr [64 x i16]* %col_outbuf_i, i64 0, i64 %tmp_13_cast
  %tmp_4 = add i8 %tmp_5_cast, %tmp_10_cast
  %tmp_14_cast = zext i8 %tmp_4 to i64
  %buf_2d_out_addr = getelementptr [64 x i16]* %buf_2d_out, i64 0, i64 %tmp_14_cast
...
; <label>:0                                       ; preds = %dct_1d.exit
  ...
  %buf_2d_in_0_addr = getelementptr [8 x i16]* %buf_2d_in_0, i64 0, i64 %tmp_141_cast_i
  %buf_2d_in_1_addr = getelementptr [8 x i16]* %buf_2d_in_1, i64 0, i64 %tmp_141_cast_i
  %buf_2d_in_2_addr = getelementptr [8 x i16]* %buf_2d_in_2, i64 0, i64 %tmp_141_cast_i
  %buf_2d_in_3_addr = getelementptr [8 x i16]* %buf_2d_in_3, i64 0, i64 %tmp_141_cast_i
  %buf_2d_in_4_addr = getelementptr [8 x i16]* %buf_2d_in_4, i64 0, i64 %tmp_141_cast_i
  %buf_2d_in_5_addr = getelementptr [8 x i16]* %buf_2d_in_5, i64 0, i64 %tmp_141_cast_i
  %buf_2d_in_6_addr = getelementptr [8 x i16]* %buf_2d_in_6, i64 0, i64 %tmp_141_cast_i
  %buf_2d_in_7_addr = getelementptr [8 x i16]* %buf_2d_in_7, i64 0, i64 %tmp_141_cast_i
  br label %1
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_2_i = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str) nounwind
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind
  %tmp_i_17 = zext i4 %k_i to i64
  %tmp_i_cast = zext i4 %k_i to i8
  %tmp_5 = add i8 %tmp_16_cast, %tmp_i_cast
  %tmp_17_cast = zext i8 %tmp_5 to i64
  %row_outbuf_i_addr = getelementptr [64 x i16]* %row_outbuf_i, i64 0, i64 %tmp_17_cast
  %dct_coeff_table_0_ad = getelementptr [8 x i14]* @dct_coeff_table_0, i64 0, i64 %tmp_i_17
  ...
  %tmp_7_cast_i = sext i16 %buf_2d_in_0_load to i29
  %tmp_8_i = mul i29 %coeff_cast_i, %tmp_7_cast_i
  %dct_coeff_table_1_ad = getelementptr [8 x i15]* @dct_coeff_table_1, i64 0, i64 %tmp_i_17
  ...
  %tmp_7_1_cast_i = sext i16 %buf_2d_in_1_load to i29
  %tmp_8_1_i = mul i29 %coeff_1_cast_i, %tmp_7_1_cast_i
  %dct_coeff_table_2_ad = getelementptr [8 x i15]* @dct_coeff_table_2, i64 0, i64 %tmp_i_17
  ...
  %tmp_7_2_cast_i = sext i16 %buf_2d_in_2_load to i29
  %tmp_8_2_i = mul i29 %coeff_2_cast_i, %tmp_7_2_cast_i
  %dct_coeff_table_3_ad = getelementptr [8 x i15]* @dct_coeff_table_3, i64 0, i64 %tmp_i_17
  ...
  %tmp_7_3_cast_i = sext i16 %buf_2d_in_3_load to i29
  %tmp_8_3_i = mul i29 %coeff_3_cast_i, %tmp_7_3_cast_i
  %dct_coeff_table_4_ad = getelementptr [8 x i15]* @dct_coeff_table_4, i64 0, i64 %tmp_i_17
  ...
  %tmp_7_4_cast_i = sext i16 %buf_2d_in_4_load to i29
  %tmp_8_4_i = mul i29 %coeff_4_cast_i, %tmp_7_4_cast_i
  %dct_coeff_table_5_ad = getelementptr [8 x i15]* @dct_coeff_table_5, i64 0, i64 %tmp_i_17
  ...
  %tmp_7_5_cast_i = sext i16 %buf_2d_in_5_load to i29
  %tmp_8_5_i = mul i29 %coeff_5_cast_i, %tmp_7_5_cast_i
  %dct_coeff_table_6_ad = getelementptr [8 x i15]* @dct_coeff_table_6, i64 0, i64 %tmp_i_17
  ...
  %tmp_7_6_cast_i = sext i16 %buf_2d_in_6_load to i29
  %tmp_8_6_i = mul i29 %coeff_6_cast_i, %tmp_7_6_cast_i
  %dct_coeff_table_7_ad = getelementptr [8 x i15]* @dct_coeff_table_7, i64 0, i64 %tmp_i_17
  ...
  %tmp_7_7_cast_i = sext i16 %buf_2d_in_7_load to i29
  %tmp_8_7_i = mul i29 %coeff_7_cast_i, %tmp_7_7_cast_i
  %tmp2 = add i29 %tmp_8_1_i, %tmp_8_i
  %tmp3 = add i29 %tmp_8_3_i, %tmp_8_2_i
  %tmp1 = add i29 %tmp2, %tmp3
  %tmp5 = add i29 %tmp_8_5_i, %tmp_8_4_i
  %tmp7 = add i29 %tmp_8_7_i, 4096
  %tmp6 = add i29 %tmp_8_6_i, %tmp7
  %tmp4 = add i29 %tmp5, %tmp6
  %tmp_3_i = add i29 %tmp1, %tmp4
  ...
  %empty_18 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str, i32 %tmp_2_i) nounwind
  br label %1
}
...
; <label>:0                                       ; preds = %.preheader1.i
  ...
  %col_inbuf_0_addr = getelementptr [8 x i16]* %col_inbuf_0, i64 0, i64 %tmp_141_cast_i
  %col_inbuf_1_addr = getelementptr [8 x i16]* %col_inbuf_1, i64 0, i64 %tmp_141_cast_i
  %col_inbuf_2_addr = getelementptr [8 x i16]* %col_inbuf_2, i64 0, i64 %tmp_141_cast_i
  %col_inbuf_3_addr = getelementptr [8 x i16]* %col_inbuf_3, i64 0, i64 %tmp_141_cast_i
  %col_inbuf_4_addr = getelementptr [8 x i16]* %col_inbuf_4, i64 0, i64 %tmp_141_cast_i
  %col_inbuf_5_addr = getelementptr [8 x i16]* %col_inbuf_5, i64 0, i64 %tmp_141_cast_i
  %col_inbuf_6_addr = getelementptr [8 x i16]* %col_inbuf_6, i64 0, i64 %tmp_141_cast_i
  %col_inbuf_7_addr = getelementptr [8 x i16]* %col_inbuf_7, i64 0, i64 %tmp_141_cast_i
  br label %1
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_2_i = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str) nounwind
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind
  %tmp_i_20 = zext i4 %k_i to i64
  %tmp_i_cast = zext i4 %k_i to i8
  %tmp_6 = add i8 %tmp_19_cast, %tmp_i_cast
  %tmp_20_cast = zext i8 %tmp_6 to i64
  %col_outbuf_i_addr = getelementptr [64 x i16]* %col_outbuf_i, i64 0, i64 %tmp_20_cast
  %dct_coeff_table_0_ad = getelementptr [8 x i14]* @dct_coeff_table_0, i64 0, i64 %tmp_i_20
  %dct_coeff_table_0_lo = load i14* %dct_coeff_table_0_ad, align 2
  %coeff_cast_i = zext i14 %dct_coeff_table_0_lo to i29
  %col_inbuf_0_load = load i16* %col_inbuf_0_addr, align 2
  %tmp_7_cast_i = sext i16 %col_inbuf_0_load to i29
  %tmp_8_i = mul i29 %coeff_cast_i, %tmp_7_cast_i
  %dct_coeff_table_1_ad = getelementptr [8 x i15]* @dct_coeff_table_1, i64 0, i64 %tmp_i_20
  %dct_coeff_table_1_lo = load i15* %dct_coeff_table_1_ad, align 2
  %coeff_1_cast_i = sext i15 %dct_coeff_table_1_lo to i29
  %col_inbuf_1_load = load i16* %col_inbuf_1_addr, align 2
  %tmp_7_1_cast_i = sext i16 %col_inbuf_1_load to i29
  %tmp_8_1_i = mul i29 %coeff_1_cast_i, %tmp_7_1_cast_i
  %dct_coeff_table_2_ad = getelementptr [8 x i15]* @dct_coeff_table_2, i64 0, i64 %tmp_i_20
  %dct_coeff_table_2_lo = load i15* %dct_coeff_table_2_ad, align 2
  %coeff_2_cast_i = sext i15 %dct_coeff_table_2_lo to i29
  %col_inbuf_2_load = load i16* %col_inbuf_2_addr, align 2
  %tmp_7_2_cast_i = sext i16 %col_inbuf_2_load to i29
  %tmp_8_2_i = mul i29 %coeff_2_cast_i, %tmp_7_2_cast_i
  %dct_coeff_table_3_ad = getelementptr [8 x i15]* @dct_coeff_table_3, i64 0, i64 %tmp_i_20
  %dct_coeff_table_3_lo = load i15* %dct_coeff_table_3_ad, align 2
  %coeff_3_cast_i = sext i15 %dct_coeff_table_3_lo to i29
  %col_inbuf_3_load = load i16* %col_inbuf_3_addr, align 2
  %tmp_7_3_cast_i = sext i16 %col_inbuf_3_load to i29
  %tmp_8_3_i = mul i29 %coeff_3_cast_i, %tmp_7_3_cast_i
  %dct_coeff_table_4_ad = getelementptr [8 x i15]* @dct_coeff_table_4, i64 0, i64 %tmp_i_20
  %dct_coeff_table_4_lo = load i15* %dct_coeff_table_4_ad, align 2
  %coeff_4_cast_i = sext i15 %dct_coeff_table_4_lo to i29
  %col_inbuf_4_load = load i16* %col_inbuf_4_addr, align 2
  %tmp_7_4_cast_i = sext i16 %col_inbuf_4_load to i29
  %tmp_8_4_i = mul i29 %coeff_4_cast_i, %tmp_7_4_cast_i
  %dct_coeff_table_5_ad = getelementptr [8 x i15]* @dct_coeff_table_5, i64 0, i64 %tmp_i_20
  %dct_coeff_table_5_lo = load i15* %dct_coeff_table_5_ad, align 2
  %coeff_5_cast_i = sext i15 %dct_coeff_table_5_lo to i29
  %col_inbuf_5_load = load i16* %col_inbuf_5_addr, align 2
  %tmp_7_5_cast_i = sext i16 %col_inbuf_5_load to i29
  %tmp_8_5_i = mul i29 %coeff_5_cast_i, %tmp_7_5_cast_i
  %dct_coeff_table_6_ad = getelementptr [8 x i15]* @dct_coeff_table_6, i64 0, i64 %tmp_i_20
  %dct_coeff_table_6_lo = load i15* %dct_coeff_table_6_ad, align 2
  %coeff_6_cast_i = sext i15 %dct_coeff_table_6_lo to i29
  %col_inbuf_6_load = load i16* %col_inbuf_6_addr, align 2
  %tmp_7_6_cast_i = sext i16 %col_inbuf_6_load to i29
  %tmp_8_6_i = mul i29 %coeff_6_cast_i, %tmp_7_6_cast_i
  %dct_coeff_table_7_ad = getelementptr [8 x i15]* @dct_coeff_table_7, i64 0, i64 %tmp_i_20
  %dct_coeff_table_7_lo = load i15* %dct_coeff_table_7_ad, align 2
  %coeff_7_cast_i = sext i15 %dct_coeff_table_7_lo to i29
  %col_inbuf_7_load = load i16* %col_inbuf_7_addr, align 2
  %tmp_7_7_cast_i = sext i16 %col_inbuf_7_load to i29
  %tmp_8_7_i = mul i29 %coeff_7_cast_i, %tmp_7_7_cast_i
  %tmp1 = add i29 %tmp_8_1_i, %tmp_8_i
  %tmp2 = add i29 %tmp_8_3_i, %tmp_8_2_i
  %tmp = add i29 %tmp1, %tmp2
  %tmp4 = add i29 %tmp_8_5_i, %tmp_8_4_i
  %tmp6 = add i29 %tmp_8_7_i, 4096
  %tmp5 = add i29 %tmp_8_6_i, %tmp6
  %tmp3 = add i29 %tmp4, %tmp5
  %tmp_3_i = add i29 %tmp, %tmp3
  %tmp_5_i = call i16 @_ssdm_op_PartSelect.i16.i29.i32.i32(i29 %tmp_3_i, i32 13, i32 28)
  store i16 %tmp_5_i, i16* %col_outbuf_i_addr, align 2
  %empty_21 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str, i32 %tmp_2_i) nounwind
  br label %1
}
