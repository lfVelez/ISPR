...
set_directive_array_reshape -type complete -dim 2 "dct" buf_2d_in
set_directive_array_reshape -type complete -dim 2 "dct_2d" col_inbuf
set_directive_dataflow "dct"
set_directive_inline "dct_2d"
set_directive_array_reshape -type complete -dim 2 "dct_1d" dct_coeff_table
