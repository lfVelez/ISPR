; ModuleID = '/home/lfvelez/Documentos/ISPR/HLS/labsource/labs/lab3/dct.prj/solution7/.autopilot/db/a.g.bc'
...
define void @dct_1d(i16* %src, i16* %dst) nounwind uwtable {
  ...
  call void (...)* @_ssdm_SpecArrayReshape([8 x i16]* getelementptr inbounds ([8 x [8 x i16]]* @dct_1d.dct_coeff_table, i32 0, i32 0), i32 2, i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !73 ; [debug line = 11:1]
...
; <label>:9                                       ; preds = %6
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([15 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !76 ; [debug line = 13:67]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !76 ; [debug line = 13:67]
...
; <label>:14                                      ; preds = %11
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([15 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !81 ; [debug line = 15:78]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !81 ; [debug line = 15:78]
  ...
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !87 ; [debug line = 18:7]
...
; <label>:36                                      ; preds = %11
  ...
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !90 ; [debug line = 20:4]
...
define void @dct_2d([8 x i16]* %in_block, [8 x i16]* %out_block) nounwind uwtable {
  ...
  call void (...)* @_ssdm_InlineSelf(i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !100 ; [debug line = 26:1]
  ...
  call void (...)* @_ssdm_SpecArrayReshape([8 x i16]* %5, i32 2, i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !108 ; [debug line = 28:1]
...
; <label>:7                                       ; preds = %20, %6
  ...
  br i1 %9, label %10, label %23, !dbg !114       ; [debug line = 32:8]

; <label>:10                                      ; preds = %7
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([13 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !116 ; [debug line = 32:66]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([13 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !116 ; [debug line = 32:66]
  %11 = load i32* %i, align 4, !dbg !118          ; [#uses=1 type=i32] [debug line = 33:7]
  %12 = zext i32 %11 to i64, !dbg !118            ; [#uses=1 type=i64] [debug line = 33:7]
  %13 = load [8 x i16]** %1, align 8, !dbg !118   ; [#uses=1 type=[8 x i16]*] [debug line = 33:7]
  %14 = getelementptr inbounds [8 x i16]* %13, i64 %12, !dbg !118 ; [#uses=1 type=[8 x i16]*] [debug line = 33:7]
  %15 = getelementptr inbounds [8 x i16]* %14, i32 0, i32 0, !dbg !118 ; [#uses=1 type=i16*] [debug line = 33:7]
  %16 = load i32* %i, align 4, !dbg !118          ; [#uses=1 type=i32] [debug line = 33:7]
  %17 = zext i32 %16 to i64, !dbg !118            ; [#uses=1 type=i64] [debug line = 33:7]
  %18 = getelementptr inbounds [8 x [8 x i16]]* %row_outbuf, i32 0, i64 %17, !dbg !118 ; [#uses=1 type=[8 x i16]*] [debug line = 33:7]
  %19 = getelementptr inbounds [8 x i16]* %18, i32 0, i32 0, !dbg !118 ; [#uses=1 type=i16*] [debug line = 33:7]
  call void @dct_1d(i16* %15, i16* %19), !dbg !118 ; [debug line = 33:7]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([13 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !119 ; [debug line = 34:4]
  br label %20, !dbg !119                         ; [debug line = 34:4]

; <label>:20                                      ; preds = %10
  %21 = load i32* %i, align 4, !dbg !120          ; [#uses=1 type=i32] [debug line = 32:60]
  %22 = add i32 %21, 1, !dbg !120                 ; [#uses=1 type=i32] [debug line = 32:60]
  store i32 %22, i32* %i, align 4, !dbg !120      ; [debug line = 32:60]
  br label %7, !dbg !120                          ; [debug line = 32:60]

; <label>:23                                      ; preds = %7
  br label %24, !dbg !121                         ; [debug line = 34:4]

; <label>:24                                      ; preds = %23
  store i32 0, i32* %j, align 4, !dbg !122        ; [debug line = 37:9]
  br label %25, !dbg !122                         ; [debug line = 37:9]

; <label>:25                                      ; preds = %51, %24
  %26 = load i32* %j, align 4, !dbg !122          ; [#uses=1 type=i32] [debug line = 37:9]
  %27 = icmp ult i32 %26, 8, !dbg !122            ; [#uses=1 type=i1] [debug line = 37:9]
  br i1 %27, label %28, label %54, !dbg !122      ; [debug line = 37:9]

; <label>:28                                      ; preds = %25
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([21 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !124 ; [debug line = 38:1]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([21 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !124 ; [debug line = 38:1]
  br label %29, !dbg !124                         ; [debug line = 38:1]

; <label>:29                                      ; preds = %28
  store i32 0, i32* %i, align 4, !dbg !126        ; [debug line = 39:11]
  br label %30, !dbg !126                         ; [debug line = 39:11]

; <label>:30                                      ; preds = %47, %29
  %31 = load i32* %i, align 4, !dbg !126          ; [#uses=1 type=i32] [debug line = 39:11]
  %32 = icmp ult i32 %31, 8, !dbg !126            ; [#uses=1 type=i1] [debug line = 39:11]
  br i1 %32, label %33, label %50, !dbg !126      ; [debug line = 39:11]

; <label>:33                                      ; preds = %30
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([21 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !128 ; [debug line = 40:2]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([21 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !128 ; [debug line = 40:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !130 ; [debug line = 41:1]
  %34 = load i32* %j, align 4, !dbg !131          ; [#uses=1 type=i32] [debug line = 40:1]
  %35 = zext i32 %34 to i64, !dbg !131            ; [#uses=1 type=i64] [debug line = 40:1]
  %36 = load i32* %i, align 4, !dbg !131          ; [#uses=1 type=i32] [debug line = 40:1]
  %37 = zext i32 %36 to i64, !dbg !131            ; [#uses=1 type=i64] [debug line = 40:1]
  %38 = getelementptr inbounds [8 x [8 x i16]]* %row_outbuf, i32 0, i64 %37, !dbg !131 ; [#uses=1 type=[8 x i16]*] [debug line = 40:1]
  %39 = getelementptr inbounds [8 x i16]* %38, i32 0, i64 %35, !dbg !131 ; [#uses=1 type=i16*] [debug line = 40:1]
  %40 = load i16* %39, align 2, !dbg !131         ; [#uses=1 type=i16] [debug line = 40:1]
  %41 = load i32* %i, align 4, !dbg !131          ; [#uses=1 type=i32] [debug line = 40:1]
  %42 = zext i32 %41 to i64, !dbg !131            ; [#uses=1 type=i64] [debug line = 40:1]
  %43 = load i32* %j, align 4, !dbg !131          ; [#uses=1 type=i32] [debug line = 40:1]
  %44 = zext i32 %43 to i64, !dbg !131            ; [#uses=1 type=i64] [debug line = 40:1]
  %45 = getelementptr inbounds [8 x [8 x i16]]* %col_inbuf, i32 0, i64 %44, !dbg !131 ; [#uses=1 type=[8 x i16]*] [debug line = 40:1]
  %46 = getelementptr inbounds [8 x i16]* %45, i32 0, i64 %42, !dbg !131 ; [#uses=1 type=i16*] [debug line = 40:1]
  store i16 %40, i16* %46, align 2, !dbg !131     ; [debug line = 40:1]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([21 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !132 ; [debug line = 40:34]
  br label %47, !dbg !132                         ; [debug line = 40:34]

; <label>:47                                      ; preds = %33
  %48 = load i32* %i, align 4, !dbg !133          ; [#uses=1 type=i32] [debug line = 39:63]
  %49 = add i32 %48, 1, !dbg !133                 ; [#uses=1 type=i32] [debug line = 39:63]
  store i32 %49, i32* %i, align 4, !dbg !133      ; [debug line = 39:63]
  br label %30, !dbg !133                         ; [debug line = 39:63]

; <label>:50                                      ; preds = %30
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([21 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !134 ; [debug line = 40:34]
  br label %51, !dbg !134                         ; [debug line = 40:34]

; <label>:51                                      ; preds = %50
  %52 = load i32* %j, align 4, !dbg !135          ; [#uses=1 type=i32] [debug line = 37:61]
  %53 = add i32 %52, 1, !dbg !135                 ; [#uses=1 type=i32] [debug line = 37:61]
  store i32 %53, i32* %j, align 4, !dbg !135      ; [debug line = 37:61]
  br label %25, !dbg !135                         ; [debug line = 37:61]

; <label>:54                                      ; preds = %25
  br label %55, !dbg !136                         ; [debug line = 40:34]

; <label>:55                                      ; preds = %54
  store i32 0, i32* %i, align 4, !dbg !137        ; [debug line = 43:9]
  br label %56, !dbg !137                         ; [debug line = 43:9]

; <label>:56                                      ; preds = %68, %55
  %57 = load i32* %i, align 4, !dbg !137          ; [#uses=1 type=i32] [debug line = 43:9]
  %58 = icmp ult i32 %57, 8, !dbg !137            ; [#uses=1 type=i1] [debug line = 43:9]
  br i1 %58, label %59, label %71, !dbg !137      ; [debug line = 43:9]

; <label>:59                                      ; preds = %56
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([13 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !139 ; [debug line = 43:67]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([13 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !139 ; [debug line = 43:67]
  %60 = load i32* %i, align 4, !dbg !141          ; [#uses=1 type=i32] [debug line = 44:7]
  %61 = zext i32 %60 to i64, !dbg !141            ; [#uses=1 type=i64] [debug line = 44:7]
  %62 = getelementptr inbounds [8 x [8 x i16]]* %col_inbuf, i32 0, i64 %61, !dbg !141 ; [#uses=1 type=[8 x i16]*] [debug line = 44:7]
  %63 = getelementptr inbounds [8 x i16]* %62, i32 0, i32 0, !dbg !141 ; [#uses=1 type=i16*] [debug line = 44:7]
  %64 = load i32* %i, align 4, !dbg !141          ; [#uses=1 type=i32] [debug line = 44:7]
  %65 = zext i32 %64 to i64, !dbg !141            ; [#uses=1 type=i64] [debug line = 44:7]
  %66 = getelementptr inbounds [8 x [8 x i16]]* %col_outbuf, i32 0, i64 %65, !dbg !141 ; [#uses=1 type=[8 x i16]*] [debug line = 44:7]
  %67 = getelementptr inbounds [8 x i16]* %66, i32 0, i32 0, !dbg !141 ; [#uses=1 type=i16*] [debug line = 44:7]
  call void @dct_1d(i16* %63, i16* %67), !dbg !141 ; [debug line = 44:7]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([13 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !142 ; [debug line = 45:4]
  br label %68, !dbg !142                         ; [debug line = 45:4]

; <label>:68                                      ; preds = %59
  %69 = load i32* %i, align 4, !dbg !143          ; [#uses=1 type=i32] [debug line = 43:61]
  %70 = add i32 %69, 1, !dbg !143                 ; [#uses=1 type=i32] [debug line = 43:61]
  store i32 %70, i32* %i, align 4, !dbg !143      ; [debug line = 43:61]
  br label %56, !dbg !143                         ; [debug line = 43:61]

; <label>:71                                      ; preds = %56
  br label %72, !dbg !144                         ; [debug line = 45:4]

; <label>:72                                      ; preds = %71
  store i32 0, i32* %j, align 4, !dbg !145        ; [debug line = 48:9]
  br label %73, !dbg !145                         ; [debug line = 48:9]

; <label>:73                                      ; preds = %100, %72
  %74 = load i32* %j, align 4, !dbg !145          ; [#uses=1 type=i32] [debug line = 48:9]
  %75 = icmp ult i32 %74, 8, !dbg !145            ; [#uses=1 type=i1] [debug line = 48:9]
  br i1 %75, label %76, label %103, !dbg !145     ; [debug line = 48:9]

; <label>:76                                      ; preds = %73
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([21 x i8]* @.str8, i32 0, i32 0)) nounwind, !dbg !147 ; [debug line = 49:1]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([21 x i8]* @.str8, i32 0, i32 0)) nounwind, !dbg !147 ; [debug line = 49:1]
  br label %77, !dbg !147                         ; [debug line = 49:1]

; <label>:77                                      ; preds = %76
  store i32 0, i32* %i, align 4, !dbg !149        ; [debug line = 50:11]
  br label %78, !dbg !149                         ; [debug line = 50:11]

; <label>:78                                      ; preds = %96, %77
  %79 = load i32* %i, align 4, !dbg !149          ; [#uses=1 type=i32] [debug line = 50:11]
  %80 = icmp ult i32 %79, 8, !dbg !149            ; [#uses=1 type=i1] [debug line = 50:11]
  br i1 %80, label %81, label %99, !dbg !149      ; [debug line = 50:11]

; <label>:81                                      ; preds = %78
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([21 x i8]* @.str9, i32 0, i32 0)) nounwind, !dbg !151 ; [debug line = 51:2]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([21 x i8]* @.str9, i32 0, i32 0)) nounwind, !dbg !151 ; [debug line = 51:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !153 ; [debug line = 52:1]
  %82 = load i32* %j, align 4, !dbg !154          ; [#uses=1 type=i32] [debug line = 51:1]
  %83 = zext i32 %82 to i64, !dbg !154            ; [#uses=1 type=i64] [debug line = 51:1]
  %84 = load i32* %i, align 4, !dbg !154          ; [#uses=1 type=i32] [debug line = 51:1]
  %85 = zext i32 %84 to i64, !dbg !154            ; [#uses=1 type=i64] [debug line = 51:1]
  %86 = getelementptr inbounds [8 x [8 x i16]]* %col_outbuf, i32 0, i64 %85, !dbg !154 ; [#uses=1 type=[8 x i16]*] [debug line = 51:1]
  %87 = getelementptr inbounds [8 x i16]* %86, i32 0, i64 %83, !dbg !154 ; [#uses=1 type=i16*] [debug line = 51:1]
  %88 = load i16* %87, align 2, !dbg !154         ; [#uses=1 type=i16] [debug line = 51:1]
  %89 = load i32* %i, align 4, !dbg !154          ; [#uses=1 type=i32] [debug line = 51:1]
  %90 = zext i32 %89 to i64, !dbg !154            ; [#uses=1 type=i64] [debug line = 51:1]
  %91 = load i32* %j, align 4, !dbg !154          ; [#uses=1 type=i32] [debug line = 51:1]
  %92 = zext i32 %91 to i64, !dbg !154            ; [#uses=1 type=i64] [debug line = 51:1]
  %93 = load [8 x i16]** %2, align 8, !dbg !154   ; [#uses=1 type=[8 x i16]*] [debug line = 51:1]
  %94 = getelementptr inbounds [8 x i16]* %93, i64 %92, !dbg !154 ; [#uses=1 type=[8 x i16]*] [debug line = 51:1]
  %95 = getelementptr inbounds [8 x i16]* %94, i32 0, i64 %90, !dbg !154 ; [#uses=1 type=i16*] [debug line = 51:1]
  store i16 %88, i16* %95, align 2, !dbg !154     ; [debug line = 51:1]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([21 x i8]* @.str9, i32 0, i32 0)) nounwind, !dbg !155 ; [debug line = 51:34]
  br label %96, !dbg !155                         ; [debug line = 51:34]

; <label>:96                                      ; preds = %81
  %97 = load i32* %i, align 4, !dbg !156          ; [#uses=1 type=i32] [debug line = 50:63]
  %98 = add i32 %97, 1, !dbg !156                 ; [#uses=1 type=i32] [debug line = 50:63]
  store i32 %98, i32* %i, align 4, !dbg !156      ; [debug line = 50:63]
  br label %78, !dbg !156                         ; [debug line = 50:63]

; <label>:99                                      ; preds = %78
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([21 x i8]* @.str8, i32 0, i32 0)) nounwind, !dbg !157 ; [debug line = 51:34]
  br label %100, !dbg !157                        ; [debug line = 51:34]

; <label>:100                                     ; preds = %99
  %101 = load i32* %j, align 4, !dbg !158         ; [#uses=1 type=i32] [debug line = 48:61]
  %102 = add i32 %101, 1, !dbg !158               ; [#uses=1 type=i32] [debug line = 48:61]
  store i32 %102, i32* %j, align 4, !dbg !158     ; [debug line = 48:61]
  br label %73, !dbg !158                         ; [debug line = 48:61]
...
define void @read_data(i16* %input, [8 x i16]* %buf) nounwind uwtable {
  ...
  %3 = load i16** %1, align 8, !dbg !164          ; [#uses=1 type=i16*] [debug line = 55:2]
  call void (...)* @_ssdm_SpecArrayDimSize(i16* %3, i32 64) nounwind, !dbg !164 ; [debug line = 55:2]
  %4 = load [8 x i16]** %2, align 8, !dbg !166    ; [#uses=1 type=[8 x i16]*] [debug line = 55:40]
  call void (...)* @_ssdm_SpecArrayDimSize([8 x i16]* %4, i32 8) nounwind, !dbg !166 ; [debug line = 55:40]
...
; <label>:6                                       ; preds = %34, %5
  ...
  br i1 %8, label %9, label %37, !dbg !172        ; [debug line = 59:9]

; <label>:9                                       ; preds = %6
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([12 x i8]* @.str10, i32 0, i32 0)) nounwind, !dbg !174 ; [debug line = 59:67]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str10, i32 0, i32 0)) nounwind, !dbg !174 ; [debug line = 59:67]
...
; <label>:11                                      ; preds = %30, %10
  ...
  br i1 %13, label %14, label %33, !dbg !176      ; [debug line = 61:12]

; <label>:14                                      ; preds = %11
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0)) nounwind, !dbg !178 ; [debug line = 62:2]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0)) nounwind, !dbg !178 ; [debug line = 62:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !180 ; [debug line = 63:1]
  ...
  %19 = sext i32 %18 to i64, !dbg !181            ; [#uses=1 type=i64] [debug line = 62:1]
  %20 = load i16** %1, align 8, !dbg !181         ; [#uses=1 type=i16*] [debug line = 62:1]
  %21 = getelementptr inbounds i16* %20, i64 %19, !dbg !181 ; [#uses=1 type=i16*] [debug line = 62:1]
  %22 = load i16* %21, align 2, !dbg !181         ; [#uses=1 type=i16] [debug line = 62:1]
  %23 = load i32* %c, align 4, !dbg !181          ; [#uses=1 type=i32] [debug line = 62:1]
  %24 = sext i32 %23 to i64, !dbg !181            ; [#uses=1 type=i64] [debug line = 62:1]
  %25 = load i32* %r, align 4, !dbg !181          ; [#uses=1 type=i32] [debug line = 62:1]
  %26 = sext i32 %25 to i64, !dbg !181            ; [#uses=1 type=i64] [debug line = 62:1]
  %27 = load [8 x i16]** %2, align 8, !dbg !181   ; [#uses=1 type=[8 x i16]*] [debug line = 62:1]
  %28 = getelementptr inbounds [8 x i16]* %27, i64 %26, !dbg !181 ; [#uses=1 type=[8 x i16]*] [debug line = 62:1]
  %29 = getelementptr inbounds [8 x i16]* %28, i32 0, i64 %24, !dbg !181 ; [#uses=1 type=i16*] [debug line = 62:1]
  store i16 %22, i16* %29, align 2, !dbg !181     ; [debug line = 62:1]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0)) nounwind, !dbg !182 ; [debug line = 62:66]
  br label %30, !dbg !182                         ; [debug line = 62:66]

; <label>:30                                      ; preds = %14
  %31 = load i32* %c, align 4, !dbg !183          ; [#uses=1 type=i32] [debug line = 61:64]
  %32 = add nsw i32 %31, 1, !dbg !183             ; [#uses=1 type=i32] [debug line = 61:64]
  store i32 %32, i32* %c, align 4, !dbg !183      ; [debug line = 61:64]
  br label %11, !dbg !183                         ; [debug line = 61:64]

; <label>:33                                      ; preds = %11
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str10, i32 0, i32 0)) nounwind, !dbg !184 ; [debug line = 63:4]
  br label %34, !dbg !184                         ; [debug line = 63:4]

; <label>:34                                      ; preds = %33
  %35 = load i32* %r, align 4, !dbg !185          ; [#uses=1 type=i32] [debug line = 59:61]
  %36 = add nsw i32 %35, 1, !dbg !185             ; [#uses=1 type=i32] [debug line = 59:61]
  store i32 %36, i32* %r, align 4, !dbg !185      ; [debug line = 59:61]
...
define void @write_data([8 x i16]* %buf, i16* %output) nounwind uwtable {
  ...
  %3 = load i16** %2, align 8, !dbg !191          ; [#uses=1 type=i16*] [debug line = 67:2]
  call void (...)* @_ssdm_SpecArrayDimSize(i16* %3, i32 64) nounwind, !dbg !191 ; [debug line = 67:2]
  %4 = load [8 x i16]** %1, align 8, !dbg !193    ; [#uses=1 type=[8 x i16]*] [debug line = 67:41]
  call void (...)* @_ssdm_SpecArrayDimSize([8 x i16]* %4, i32 8) nounwind, !dbg !193 ; [debug line = 67:41]
...
; <label>:6                                       ; preds = %34, %5
  ...
  br i1 %8, label %9, label %37, !dbg !199        ; [debug line = 71:9]

; <label>:9                                       ; preds = %6
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([12 x i8]* @.str12, i32 0, i32 0)) nounwind, !dbg !201 ; [debug line = 71:67]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str12, i32 0, i32 0)) nounwind, !dbg !201 ; [debug line = 71:67]
...
; <label>:11                                      ; preds = %30, %10
  ...
  br i1 %13, label %14, label %33, !dbg !203      ; [debug line = 73:12]

; <label>:14                                      ; preds = %11
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([12 x i8]* @.str13, i32 0, i32 0)) nounwind, !dbg !205 ; [debug line = 74:2]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str13, i32 0, i32 0)) nounwind, !dbg !205 ; [debug line = 74:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !207 ; [debug line = 75:1]
  %15 = load i32* %c, align 4, !dbg !208          ; [#uses=1 type=i32] [debug line = 74:1]
  %16 = sext i32 %15 to i64, !dbg !208            ; [#uses=1 type=i64] [debug line = 74:1]
  %17 = load i32* %r, align 4, !dbg !208          ; [#uses=1 type=i32] [debug line = 74:1]
  %18 = sext i32 %17 to i64, !dbg !208            ; [#uses=1 type=i64] [debug line = 74:1]
  %19 = load [8 x i16]** %1, align 8, !dbg !208   ; [#uses=1 type=[8 x i16]*] [debug line = 74:1]
  %20 = getelementptr inbounds [8 x i16]* %19, i64 %18, !dbg !208 ; [#uses=1 type=[8 x i16]*] [debug line = 74:1]
  %21 = getelementptr inbounds [8 x i16]* %20, i32 0, i64 %16, !dbg !208 ; [#uses=1 type=i16*] [debug line = 74:1]
  %22 = load i16* %21, align 2, !dbg !208         ; [#uses=1 type=i16] [debug line = 74:1]
  %23 = load i32* %r, align 4, !dbg !208          ; [#uses=1 type=i32] [debug line = 74:1]
  %24 = mul nsw i32 %23, 8, !dbg !208             ; [#uses=1 type=i32] [debug line = 74:1]
  %25 = load i32* %c, align 4, !dbg !208          ; [#uses=1 type=i32] [debug line = 74:1]
  %26 = add nsw i32 %24, %25, !dbg !208           ; [#uses=1 type=i32] [debug line = 74:1]
  %27 = sext i32 %26 to i64, !dbg !208            ; [#uses=1 type=i64] [debug line = 74:1]
  %28 = load i16** %2, align 8, !dbg !208         ; [#uses=1 type=i16*] [debug line = 74:1]
  %29 = getelementptr inbounds i16* %28, i64 %27, !dbg !208 ; [#uses=1 type=i16*] [debug line = 74:1]
  store i16 %22, i16* %29, align 2, !dbg !208     ; [debug line = 74:1]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str13, i32 0, i32 0)) nounwind, !dbg !209 ; [debug line = 74:67]
  br label %30, !dbg !209                         ; [debug line = 74:67]

; <label>:30                                      ; preds = %14
  %31 = load i32* %c, align 4, !dbg !210          ; [#uses=1 type=i32] [debug line = 73:64]
  %32 = add nsw i32 %31, 1, !dbg !210             ; [#uses=1 type=i32] [debug line = 73:64]
  store i32 %32, i32* %c, align 4, !dbg !210      ; [debug line = 73:64]
  br label %11, !dbg !210                         ; [debug line = 73:64]

; <label>:33                                      ; preds = %11
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str12, i32 0, i32 0)) nounwind, !dbg !211 ; [debug line = 75:4]
  br label %34, !dbg !211                         ; [debug line = 75:4]

; <label>:34                                      ; preds = %33
  %35 = load i32* %r, align 4, !dbg !212          ; [#uses=1 type=i32] [debug line = 71:61]
  %36 = add nsw i32 %35, 1, !dbg !212             ; [#uses=1 type=i32] [debug line = 71:61]
  store i32 %36, i32* %r, align 4, !dbg !212      ; [debug line = 71:61]
...
define void @dct(i16* %input, i16* %output) nounwind uwtable {
  ...
  %3 = load i16** %2, align 8, !dbg !218          ; [#uses=1 type=i16*] [debug line = 79:2]
  call void (...)* @_ssdm_SpecArrayDimSize(i16* %3, i32 64) nounwind, !dbg !218 ; [debug line = 79:2]
  %4 = load i16** %1, align 8, !dbg !220          ; [#uses=1 type=i16*] [debug line = 79:41]
  call void (...)* @_ssdm_SpecArrayDimSize(i16* %4, i32 64) nounwind, !dbg !220 ; [debug line = 79:41]
  call void (...)* @_ssdm_op_SpecDataflowPipeline(i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !221 ; [debug line = 80:1]
  ...
  call void (...)* @_ssdm_SpecArrayReshape([8 x i16]* %5, i32 2, i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !225 ; [debug line = 82:1]
  ...
  %6 = load i16** %1, align 8, !dbg !228          ; [#uses=1 type=i16*] [debug line = 85:4]
  ...
  %11 = load i16** %2, align 8, !dbg !230         ; [#uses=1 type=i16*] [debug line = 90:4]
