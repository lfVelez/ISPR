...
architecture behav of dct is 
    ...
    "dct,hls_ip_2017_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=9.727437,HLS_SYN_LAT=647,HLS_SYN_TPT=134,HLS_SYN_MEM=22,HLS_SYN_DSP=16,HLS_SYN_FF=4342,HLS_SYN_LUT=5587}";
