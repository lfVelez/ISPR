...
reg   [7:0] tmp_18_cast_reg_512;
reg   [2:0] buf_2d_in_addr_reg_517;
...
wire   [7:0] tmp_5_fu_219_p2;
reg   [7:0] tmp_5_reg_531;
reg   [7:0] ap_reg_pp0_iter1_tmp_5_reg_531;
reg   [7:0] ap_reg_pp0_iter2_tmp_5_reg_531;
reg   [7:0] ap_reg_pp0_iter3_tmp_5_reg_531;
reg   [7:0] ap_reg_pp0_iter4_tmp_5_reg_531;
wire   [15:0] tmp_49_fu_224_p1;
reg  signed [15:0] tmp_49_reg_541;
wire   [15:0] tmp_50_fu_228_p1;
reg  signed [15:0] tmp_50_reg_546;
...
reg  signed [28:0] tmp6_reg_636;
reg    ap_enable_reg_pp0_iter2;
wire  signed [28:0] grp_fu_481_p3;
reg  signed [28:0] tmp2_reg_641;
reg    ap_enable_reg_pp0_iter3;
wire  signed [28:0] grp_fu_488_p3;
reg  signed [28:0] tmp3_reg_646;
(* use_dsp48 = "no" *) wire   [28:0] tmp4_fu_420_p2;
reg   [28:0] tmp4_reg_651;
...
wire   [63:0] tmp_i_29_fu_210_p1;
wire    ap_block_pp0_stage0_flag00000000;
wire   [63:0] tmp_19_cast_fu_443_p1;
wire   [6:0] tmp_s_fu_186_p3;
wire   [7:0] tmp_i_cast_fu_215_p1;
wire  signed [28:0] grp_fu_495_p3;
(* use_dsp48 = "no" *) wire   [28:0] tmp1_fu_424_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (tmp_fu_169_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (1'b1 == ap_condition_pp0_exit_iter0_state3))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (tmp_fu_169_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (tmp_fu_169_p2 == 1'd0))) begin
        buf_2d_in_addr_reg_517 <= tmp_141_cast_i_fu_181_p1;
        tmp_18_cast_reg_512[6 : 3] <= tmp_18_cast_fu_194_p1[6 : 3];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (1'd0 == tmp_i_reg_522))) begin
        ...
        tmp_11_i_reg_556 <= {{buf_2d_in_q0[31:16]}};
        tmp_12_i_reg_561 <= {{dct_coeff_table_q0[47:32]}};
        tmp_13_i_reg_566 <= {{buf_2d_in_q0[47:32]}};
        tmp_15_i_reg_571 <= {{dct_coeff_table_q0[63:48]}};
        tmp_16_i_reg_576 <= {{buf_2d_in_q0[63:48]}};
        tmp_17_i_reg_581 <= {{dct_coeff_table_q0[79:64]}};
        tmp_18_i_reg_586 <= {{buf_2d_in_q0[79:64]}};
        tmp_19_i_reg_591 <= {{dct_coeff_table_q0[95:80]}};
        tmp_1_reg_611 <= {{dct_coeff_table_q0[126:112]}};
        tmp_20_i_reg_596 <= {{buf_2d_in_q0[95:80]}};
        tmp_21_i_reg_601 <= {{dct_coeff_table_q0[111:96]}};
        tmp_22_i_reg_606 <= {{buf_2d_in_q0[111:96]}};
        tmp_24_i_reg_616 <= {{buf_2d_in_q0[127:112]}};
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (tmp_fu_169_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign buf_2d_in_address0 = buf_2d_in_addr_reg_517;

assign dct_coeff_table_address0 = tmp_i_29_fu_210_p1;

assign grp_fu_472_p2 = 29'd4096;

assign i_fu_175_p2 = (i_0_i_reg_147 + 4'd1);

assign k_fu_204_p2 = (k_i_reg_158 + 4'd1);

assign row_outbuf_i_address0 = tmp_19_cast_fu_443_p1;

assign row_outbuf_i_d0 = tmp_5_i_reg_656;

assign tmp1_fu_424_p2 = ($signed(tmp3_reg_646) + $signed(tmp2_reg_641));

assign tmp4_fu_420_p2 = ($signed(tmp6_reg_636) + $signed(grp_fu_495_p3));

assign tmp_141_cast_i_fu_181_p1 = i_0_i_reg_147;

assign tmp_18_cast_fu_194_p1 = tmp_s_fu_186_p3;

assign tmp_19_cast_fu_443_p1 = ap_reg_pp0_iter4_tmp_5_reg_531;

assign tmp_3_i_fu_428_p2 = (tmp4_reg_651 + tmp1_fu_424_p2);

assign tmp_49_fu_224_p1 = dct_coeff_table_q0[15:0];

assign tmp_50_fu_228_p1 = buf_2d_in_q0[15:0];

assign tmp_5_fu_219_p2 = (tmp_i_cast_fu_215_p1 + tmp_18_cast_reg_512);

assign tmp_fu_169_p2 = ((i_0_i_reg_147 == 4'd8) ? 1'b1 : 1'b0);

assign tmp_i_29_fu_210_p1 = k_i_reg_158;

assign tmp_i_cast_fu_215_p1 = k_i_reg_158;

assign tmp_i_fu_198_p2 = ((k_i_reg_158 == 4'd8) ? 1'b1 : 1'b0);

assign tmp_s_fu_186_p3 = {{i_0_i_reg_147}, {3'd0}};

always @ (posedge ap_clk) begin
    tmp_18_cast_reg_512[2:0] <= 3'b000;
    tmp_18_cast_reg_512[7] <= 1'b0;
end
