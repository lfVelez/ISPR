...
#ifndef __yuv_filter_mac_mukbM__HH__
#define __yuv_filter_mac_mukbM__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(yuv_filter_mac_mukbM) {
    ...
    SC_CTOR(yuv_filter_mac_mukbM):  simcore_mac_3_U ("simcore_mac_3_U") {
