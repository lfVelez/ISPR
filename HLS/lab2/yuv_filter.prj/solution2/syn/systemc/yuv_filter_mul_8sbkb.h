...
#ifndef __yuv_filter_mul_8sbkb__HH__
#define __yuv_filter_mul_8sbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(yuv_filter_mul_8sbkb) {
    ...
    SC_CTOR(yuv_filter_mul_8sbkb):  ACMP_mul_su_U ("ACMP_mul_su_U") {
