...
#ifndef __yuv_filter_p_yuv_mb6_H__
#define __yuv_filter_p_yuv_mb6_H__
...
struct yuv_filter_p_yuv_mb6_ram : public sc_core::sc_module {
...
sc_core::sc_signal<sc_lv<DataWidth> > q0_t1;
   SC_CTOR(yuv_filter_p_yuv_mb6_ram) {
...
SC_MODULE(yuv_filter_p_yuv_mb6) {
...
yuv_filter_p_yuv_mb6_ram* meminst;


SC_CTOR(yuv_filter_p_yuv_mb6) {
meminst = new yuv_filter_p_yuv_mb6_ram("yuv_filter_p_yuv_mb6_ram");
