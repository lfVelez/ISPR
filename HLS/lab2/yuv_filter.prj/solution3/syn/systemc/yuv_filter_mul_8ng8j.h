...
#ifndef __yuv_filter_mul_8ng8j__HH__
#define __yuv_filter_mul_8ng8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(yuv_filter_mul_8ng8j) {
    ...
    SC_CTOR(yuv_filter_mul_8ng8j):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
