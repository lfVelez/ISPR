...
#ifndef __yuv_filter_mul_9sg8j__HH__
#define __yuv_filter_mul_9sg8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(yuv_filter_mul_9sg8j) {
    ...
    SC_CTOR(yuv_filter_mul_9sg8j):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
