...
#ifndef __yuv_filter_p_yuv_kbM_H__
#define __yuv_filter_p_yuv_kbM_H__
...
struct yuv_filter_p_yuv_kbM_ram : public sc_core::sc_module {
...
sc_core::sc_signal<sc_lv<DataWidth> > q0_t1;
   SC_CTOR(yuv_filter_p_yuv_kbM_ram) {
...
SC_MODULE(yuv_filter_p_yuv_kbM) {
...
yuv_filter_p_yuv_kbM_ram* meminst;


SC_CTOR(yuv_filter_p_yuv_kbM) {
meminst = new yuv_filter_p_yuv_kbM_ram("yuv_filter_p_yuv_kbM_ram");
