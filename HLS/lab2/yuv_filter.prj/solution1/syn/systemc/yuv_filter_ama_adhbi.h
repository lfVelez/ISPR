...
#ifndef __yuv_filter_ama_adhbi__HH__
#define __yuv_filter_ama_adhbi__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(yuv_filter_ama_adhbi) {
    ...
    SC_CTOR(yuv_filter_ama_adhbi):  simcore_ama_0_U ("simcore_ama_0_U") {
