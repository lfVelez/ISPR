...
#ifndef __yuv_filter_mul_8nqcK__HH__
#define __yuv_filter_mul_8nqcK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(yuv_filter_mul_8nqcK) {
    ...
    SC_CTOR(yuv_filter_mul_8nqcK):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
