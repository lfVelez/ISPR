...
#ifndef __yuv_filter_mul_8nbkb__HH__
#define __yuv_filter_mul_8nbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(yuv_filter_mul_8nbkb) {
    ...
    SC_CTOR(yuv_filter_mul_8nbkb):  ACMP_mul_us_U ("ACMP_mul_us_U") {
